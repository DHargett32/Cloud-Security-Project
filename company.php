...
<html lang="en">
    <head>
        <title>Example Company Redirect</title>
        <meta charset="utf-8">
    ...
    <body>
        <div class="container">
            ...
            <form class="form-signin">
                <h1 class="form-signin-heading">Example Company Redirect</h1>
                <label for="inputUsername" class="sr-only">Username:</label>
                <input type="text" id="inputCompanyUsername" class="form-control" placeholder="Username" required>
